...
float4 plasticPS_t(vertexOutput IN,
		    uniform float3 SurfaceColor,
...
float4 plasticQPS(vertexOutput IN,
		    uniform float3 SurfaceColor,
		    uniform float Kd,
		    uniform float Ks,
		    uniform float SpecExpon,
...
float4 plasticQPS_t(vertexOutput IN,
		    uniform float3 SurfaceColor,
		    uniform sampler2D ColorSampler,
		    uniform float Kd,
		    uniform float Ks,
...
> {
    ...
    > {
        SetVertexShader( CompileShader( vs_4_0, std_dp_VS(gWorldITXf,gWorldXf,
				...
				gLamp0DirPos) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, plasticPS_t(gSurfaceColor,gColorSampler,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
						gLamp0Color,gAmbiColor) ) );
...
> {
    ...
    > {
		...
		AlphaBlendEnable = false;
		CullMode = None;
        PixelShader = compile ps_3_0 plasticPS_t(gSurfaceColor,gColorSampler,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
						gLamp0Color,gAmbiColor);
...
> {
    ...
    > {
        SetVertexShader( CompileShader( vs_4_0, std_dp_VS(gWorldITXf,gWorldXf,
				...
				gLamp0DirPos) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, plasticQPS(gSurfaceColor,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
...
> {
    ...
    > {
		...
		AlphaBlendEnable = false;
		CullMode = None;
        PixelShader = compile ps_3_0 plasticQPS(gSurfaceColor,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
						gLamp0Color,gLamp0Intensity,
...
> {
    ...
    > {
        SetVertexShader( CompileShader( vs_4_0, std_dp_VS(gWorldITXf,gWorldXf,
				...
				gLamp0DirPos) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, plasticQPS_t(gSurfaceColor,
						gColorSampler,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
...
> {
    ...
    > {
		...
		AlphaBlendEnable = false;
		CullMode = None;
        PixelShader = compile ps_3_0 plasticQPS_t(gSurfaceColor,
						gColorSampler,
						gKd,gKs,gSpecExpon,
						gKr,gFresnelMin,gFresnelExp,
						gEnvSampler,
